...
namespace Barn2\Plugin\Posts_Table_Pro\Dependencies\Lib\Plugin\License\Admin;
...
class License_Notices implements Registerable
{
    ...
    public function first_activation_notice()
    {
        ...
        \printf(
            ...
            __('Thank you for installing %1$s. To get started, please %2$s enter your license key%3$s.', 'posts-table-pro'),
            $plugin_name,
