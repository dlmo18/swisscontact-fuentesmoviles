...
namespace Barn2\Plugin\Posts_Table_Pro\Dependencies\Lib\WooCommerce\Admin;

use Barn2\Plugin\Posts_Table_Pro\Dependencies\Lib\Admin\Abstract_Plugin_Promo;
use Barn2\Plugin\Posts_Table_Pro\Dependencies\Lib\Admin\Settings_Util;
use Barn2\Plugin\Posts_Table_Pro\Dependencies\Lib\Admin\Plugin_Promo as OG_Promo;
            ...
            if (empty($hide_save_button)) {
				...
				<p class="submit barn2-settings-submit">
					<button name="save" class="button-primary woocommerce-save-button" type="submit"
							value="<?php 
                esc_attr_e('Save changes', 'posts-table-pro');
                ?>"><?php 
                esc_html_e('Save changes', 'posts-table-pro');
                ?></button>
				</p>
				<?php 
            }
