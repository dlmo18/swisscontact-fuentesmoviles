...
use Barn2\Plugin\Posts_Table_Pro\Posts_Table;
use Barn2\Plugin\Posts_Table_Pro\Table_Query;
	...
	public function update_data( $data ) {
		if ( $this->data_caching_enabled() ) {
			...
			if ( count( $data ) <= 1000 ) {
				...
				set_transient( $this->get_data_cache_key(), $data, apply_filters( 'posts_table_data_cache_expiry', $cache_expiration_length, $this ) );
			}
		} else {
