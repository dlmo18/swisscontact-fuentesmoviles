...
class Xtra_Elementor_Widget_testimonials extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Testimonials', 'codevz-plus' );
	}
	...
	public function get_keywords() {
		...
		return [
			...
			esc_html__( 'Comment', 'codevz-plus' ),
			esc_html__( 'Opinion', 'codevz-plus' ),
			esc_html__( 'Client', 'codevz-plus' ),
			esc_html__( 'Customer', 'codevz-plus' ),
	...
	public function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( 'John Carter', 'codevz-plus' ),
				'placeholder' => esc_html__( 'John Carter', 'codevz-plus' )
			]
		);
		...
		$this->add_control(
			'arrow',
			[
				'label' => esc_html__( 'Arrow', 'codevz-plus' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'' => esc_html__( 'Select', 'codevz-plus' ),
					'cz_testimonials_bottom_arrow' => esc_html__( 'Bottom left', 'codevz-plus' ),
					'cz_testimonials_top_arrow' => esc_html__( 'Top left', 'codevz-plus' ),
				],
			]
		);
	   ...
	   // Parallax settings.
		...
		$this->add_control(
			'arrow_background',
			[
				'label' => __( 'Arrow color', 'codevz-plus' ),
	...
	public function render() {
		...
		?>
		<div<?php echo wp_kses_post( (string) Codevz_Plus::classes( [], $classes ) ); ?>><?php echo wp_kses_post( (string) $outer_meta_before ); ?>
			<div class="cz_testimonials_content"><?php echo wp_kses_post( (string) $inner_meta_before ); ?>
				<div class="cz_wpe_content"><?php echo wp_kses_post( (string) $content ); ?></div>
				<?php echo wp_kses_post( (string) $inner_meta_after ); ?>
			</div>
			<?php echo wp_kses_post( (string) $outer_meta_after ); ?>
		</div>
		<?php
