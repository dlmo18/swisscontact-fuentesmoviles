...
class Xtra_Elementor_Widget_parallax_group extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Parallax Layers', 'codevz-plus' );
	}
	...
	public function get_keywords() {
		...
		return [
			...
			esc_html__( 'Parallax', 'codevz-plus' ),
			esc_html__( 'Layers', 'codevz-plus' ),
	...
	public function register_controls() {
		...
		$repeater->add_responsive_control(
			'position_top',
			[
				'label' 	=> esc_html__( 'Position top', 'codevz-plus' ),
		...
		$repeater->add_responsive_control(
			'position_left',
			[
				'label' 	=> esc_html__( 'Position left', 'codevz-plus' ),
				'type' 		=> Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range' 	=> [
					'px' 		=> [
		...
		$repeater->add_responsive_control(
			'position_right',
			[
				'label' 	=> esc_html__( 'Position right', 'codevz-plus' ),
				'type' 		=> Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range' 	=> [
					'px' 		=> [
		...
		$repeater->add_responsive_control(
			'position_bottom',
			[
				'label' 	=> esc_html__( 'Position bottom', 'codevz-plus' ),
				'type' 		=> Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range' 	=> [
					'px' 		=> [
		...
		$repeater->add_control(
			'title', [
				'label' => esc_html__( 'Hide on mobile?', 'codevz-plus' ),
		...
		$this->add_responsive_control(
			'position_bottom',
			[
				'label' 	=> esc_html__( 'Container height', 'codevz-plus' ),
				'type' 		=> Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' 	=> [
					'px' 		=> [
	...
	public function render() {
		...
		foreach ( $settings[ 'items' ] as $i ) {
			...
			echo '<div class="elementor-repeater-item-' . esc_attr( $i[ '_id' ] ) . ' cz_layer_parallax' . esc_attr( $class ) . '"><div>' . do_shortcode( $image ) . '</div></div>';
		...
		echo '<div class="cz_group_parallax">' . do_shortcode( $layers ) . '</div>';
