...
class Xtra_Elementor_Widget_attribute_box extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Attribute Box', 'codevz-plus' );
	}
	...
	public function get_keywords() {
		...
		return [
			...
			esc_html__( 'Attribute', 'codevz-plus' ),
			esc_html__( 'Box', 'codevz-plus' ),
			esc_html__( 'Info', 'codevz-plus' ),
	...
	public function register_controls() {
		...
		$this->add_control(
			'attributes',
			[
				'label' 	=> esc_html__( 'Attribute(s)', 'codevz-plus' ),
		...
		$this->add_responsive_control(
			'box_width',
			[
				'label' => esc_html__( 'Box width', 'codevz-plus' ),
		...
		$this->add_responsive_control(
			'box_align',
			[
				'label' => esc_html__( 'Alignment', 'codevz-plus' ),
				...
				'options' => [
					...
					'center' => [
						'title' => esc_html__( 'Center', 'codevz-plus' ),
	...
	public function render() {
		...
		echo do_shortcode( '<div' . Codevz_Plus::classes( [], $classes ) . '><div>' . $children . $icon . '</div></div>' );
