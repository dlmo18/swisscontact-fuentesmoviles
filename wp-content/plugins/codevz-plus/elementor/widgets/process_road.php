...
class Xtra_Elementor_Widget_process_road extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Process Road', 'codevz-plus' );
	}
	...
	public function get_keywords() {
		...
		return [
			...
			esc_html__( 'Road', 'codevz-plus' ),
			esc_html__( 'Way', 'codevz-plus' ),
			esc_html__( 'Direction', 'codevz-plus' ),
	...
	public function register_controls() {
		...
		$this->add_control(
			'road',
			[
				'label' => esc_html__( 'Road', 'codevz-plus' ),
				'type' 	=> Controls_Manager::SELECT,
				'default' => 'cz_road_cr',
				'options' => [
					'cz_road_cr' => esc_html__( 'Center to Right', 'codevz-plus' ),
					'cz_road_cb' => esc_html__( 'Center to Bottom', 'codevz-plus' ),
					'cz_road_tl cz_road_cl' => esc_html__( 'Center to Left', 'codevz-plus' ),
					'cz_road_tl cz_road_ct' => esc_html__( 'Center to Top', 'codevz-plus' ),
					'cz_road_rb' => esc_html__( 'Right to bottom ( ┌ )', 'codevz-plus' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz-plus' ) . ']' : '' ),
					'cz_road_tb' => esc_html__( 'Top to bottom ( │ )', 'codevz-plus' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz-plus' ) . ']' : '' ),
					'cz_road_tr' => esc_html__( 'Top to right ( └ )', 'codevz-plus' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz-plus' ) . ']' : '' ),
					'cz_road_tl' => esc_html__( 'Top to left ( ┘ )', 'codevz-plus' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz-plus' ) . ']' : '' ),
					'cz_road_lr' => esc_html__( 'Left to right ( ─ )', 'codevz-plus' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz-plus' ) . ']' : '' ),
					'cz_road_lb' => esc_html__( 'Left to bottom ( ┐ )', 'codevz-plus' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz-plus' ) . ']' : '' ),
					'cz_road_vr' => esc_html__( 'Vertical & Right ( ├ )', 'codevz-plus' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz-plus' ) . ']' : '' ),
					'cz_road_lb cz_road_vl' => esc_html__( 'Vertical & Left ( ┤ )', 'codevz-plus' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz-plus' ) . ']' : '' ),
					'cz_road_tr cz_road_hu' => esc_html__( 'Horizontal & Up ( ┴ )', 'codevz-plus' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz-plus' ) . ']' : '' ),
					'cz_road_hd' => esc_html__( 'Horizontal & Down ( ┬ )', 'codevz-plus' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz-plus' ) . ']' : '' ),
					'cz_road_crs' => esc_html__( 'Cross ( ┼ )', 'codevz-plus' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz-plus' ) . ']' : '' )
				],
			]
		);
		...
		$this->add_control(
			'line_border-style',
			[
				'label' => esc_html__( 'Lines style', 'codevz-plus' ),
		...
		$this->add_control(
			'line_size',
			[
				'label' => esc_html__( 'Line size', 'codevz-plus' ),
				'type' => $free ? 'codevz_pro' : Controls_Manager::SELECT,
				'default' => '',
				'options' => [
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'cz_road_icon_rhombus' => esc_html__( 'Rhombus', 'codevz-plus' ),
					'cz_road_icon_rhombus_2' => esc_html__( 'Rhombus Radius', 'codevz-plus' ),
					'cz_road_icon_rhombus_3' => esc_html__( 'Pin', 'codevz-plus' ),
					'cz_road_icon_custom' => esc_html__( 'Custom', 'codevz-plus' ),
				],
			]
		);
		...
		$this->add_control(
			'line_border-color',
			[
				'label' => esc_html__( 'Line Color', 'codevz-plus' ),
